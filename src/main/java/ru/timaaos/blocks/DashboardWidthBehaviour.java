...
public class DashboardWidthBehaviour extends BlockEntityBehaviour implements ValueSettingsBehaviour {

    public static final BehaviourType<DashboardWidthBehaviour> TYPE = new BehaviourType<>();
    ...
    public void write(NbtCompound nbt, boolean clientPacket) {
        nbt.putInt("PlotWidth", value);
        super.write(nbt, clientPacket);
    }

    @Override
    public void read(NbtCompound nbt, boolean clientPacket) {
        value = nbt.getInt("PlotWidth");
        super.read(nbt, clientPacket);
    }

    public DashboardWidthBehaviour withClientCallback(Consumer<Integer> valueCallback) {
        clientCallback = valueCallback;
        return this;
    }

    public DashboardWidthBehaviour withCallback(Consumer<Integer> valueCallback) {
        callback = valueCallback;
        return this;
    }

    public DashboardWidthBehaviour between(int min, int max) {
        this.min = min;
        this.max = max;
        return this;
    }

    public DashboardWidthBehaviour requiresWrench() {
        this.needsWrench = true;
        return this;
    }

    public DashboardWidthBehaviour withFormatter(Function<Integer, String> formatter) {
        this.formatter = formatter;
        return this;
    }

    public DashboardWidthBehaviour onlyActiveWhen(Supplier<Boolean> condition) {
        isActive = condition;
        return this;
    }
